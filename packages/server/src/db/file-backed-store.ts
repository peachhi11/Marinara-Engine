...
export const CASCADES: Array<{ parent: FileBackedTable; child: FileBackedTable; parentKey: string; childKey: string }> = [
  ...
  { parent: "characters", child: "persona_character_links", parentKey: "id", childKey: "characterId" },
  ...
  { parent: "personas", child: "persona_character_links", parentKey: "id", childKey: "personaId" },
