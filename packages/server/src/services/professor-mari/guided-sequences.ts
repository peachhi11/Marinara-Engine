...
Runtime / Narrative Arc: linked character + linked persona -> current scene state -> active pressure -> relationship stage -> 5-stage arc overview -> first message / alternate openings -> lorebook hook or update target. Tag chips entity:"chat".
